ClientEvents.lang("zh_cn", (event) => {
    ...
    AddItemLang("incomplete_foundry_mixer", "熔铸搅拌器（半成品）")
    AddItemLang("incomplete_distillation_controller", "分馏塔控制器（半成品）")
    AddItemLang("incomplete_bulk_fermenter", "批量发酵器（半成品）")
    AddItemLang("incomplete_impact_pile", "冲击桩（半成品）")
    AddItemLang("incomplete_diesel_engine", "柴油引擎（半成品）")
    AddItemLang("incomplete_pumpjack_hole", "抽油机油泵（半成品）")
    AddItemLang("incomplete_pumpjack_crank", "抽油机曲柄（半成品）")
    AddItemLang("incomplete_pumpjack_head", "抽油机驴头（半成品）")
    AddItemLang("incomplete_pumpjack_bearing", "抽油机轴承（半成品）")

    AddItemLang("incomplete_circuit_board", "电路板（半成品）")
    AddItemLang("incomplete_magnetoelectric_core", "磁电核心（半成品）")
    AddItemLang("incomplete_capacitor", "电容器（半成品）")

    AddItemLang("silicon_plate", "单晶硅板")

    AddItemLang("incomplete_electric_motor", "电动马达（半成品）")
    AddItemLang("incomplete_alternator", "交流发电机（半成品）")
    AddItemLang("incomplete_tesla_coil", "特斯拉线圈（半成品）")
    AddItemLang("incomplete_modular_accumulator", "蓄电池（半成品）")
    AddItemLang("incomplete_transmission_pole", "输电杆（半成品）")
    AddItemLang("incomplete_remote_transmission_pole", "远程输电杆（半成品）")
    AddItemLang("incomplete_heater", "加热器（半成品）")
    AddItemLang("incomplete_charge_collector", "集电器（半成品）")
    AddItemLang("incomplete_piezoelectric_crystal", "压电晶体（半成品）")
    AddItemLang("incomplete_connector", "连接器（半成品）")
    AddItemLang("incomplete_large_connector", "大型连接器（半成品）")
    AddItemLang("incomplete_portable_energy_interface", "移动式能量接口（半成品）")
