ServerEvents.recipes(event => {
	...
	create.sequenced_assembly([
		...
		create.deploying("create_feature_engineering:incomplete_magnet_mechanism", ["create_feature_engineering:incomplete_magnet_mechanism", "#forge:rubber"]),
	...
	], "create_feature_engineering:magnet_machine", [
		create.deploying("create_feature_engineering:incomplete_electric_motor", ["create_feature_engineering:incomplete_electric_motor", "#forge:plates/brass"]),
		create.deploying("create_feature_engineering:incomplete_electric_motor", ["create_feature_engineering:incomplete_electric_motor", "#anvilcraft:capacitor"]),
		create.deploying("create_feature_engineering:incomplete_electric_motor", ["create_feature_engineering:incomplete_electric_motor", "anvilcraft:magnetoelectric_core"])
	]).transitionalItem("create_feature_engineering:incomplete_electric_motor").loops(1)
	...
	create.sequenced_assembly([
		...
		create.deploying("create_feature_engineering:incomplete_alternator", ["create_feature_engineering:incomplete_alternator", "#forge:plates/iron"]),
		create.deploying("create_feature_engineering:incomplete_alternator", ["create_feature_engineering:incomplete_alternator", "#anvilcraft:capacitor"]),
		create.deploying("create_feature_engineering:incomplete_alternator", ["create_feature_engineering:incomplete_alternator", "anvilcraft:magnetoelectric_core"])
	]).transitionalItem("create_feature_engineering:incomplete_alternator").loops(1)
	...
	create.sequenced_assembly([
		...
		create.deploying("create_feature_engineering:incomplete_tesla_coil", ["create_feature_engineering:incomplete_tesla_coil", "createaddition:electrum_spool"]),
		create.deploying("create_feature_engineering:incomplete_tesla_coil", ["create_feature_engineering:incomplete_tesla_coil", "#anvilcraft:capacitor"]),
		create.deploying("create_feature_engineering:incomplete_tesla_coil", ["create_feature_engineering:incomplete_tesla_coil", "anvilcraft:magnetoelectric_core"])
	]).transitionalItem("create_feature_engineering:incomplete_tesla_coil").loops(1)
	...
	create.sequenced_assembly([
		...
		create.deploying("create_feature_engineering:incomplete_modular_accumulator", ["create_feature_engineering:incomplete_modular_accumulator", "anvilcraft:magnetoelectric_core"]),
		create.deploying("create_feature_engineering:incomplete_modular_accumulator", ["create_feature_engineering:incomplete_modular_accumulator", "#anvilcraft:capacitor"]),
		create.deploying("create_feature_engineering:incomplete_modular_accumulator", ["create_feature_engineering:incomplete_modular_accumulator", "#forge:plates/electrum"])
	]).transitionalItem("create_feature_engineering:incomplete_modular_accumulator").loops(1)

	// 连接器
	event.remove({ output: "createaddition:connector" })
	create.sequenced_assembly([
		Item.of("createaddition:connector", 4)
	], "create_feature_engineering:magnet_mechanism", [
		create.deploying("create_feature_engineering:incomplete_connector", ["create_feature_engineering:incomplete_connector", "#forge:rods/copper"]),
		create.deploying("create_feature_engineering:incomplete_connector", ["create_feature_engineering:incomplete_connector", "#forge:slimeballs"])
	]).transitionalItem("create_feature_engineering:incomplete_connector").loops(1)
	...
	create.sequenced_assembly([
		...
		create.deploying("create_feature_engineering:incomplete_large_connector", ["create_feature_engineering:incomplete_large_connector", "#forge:rods/electrum"]),
		create.deploying("create_feature_engineering:incomplete_large_connector", ["create_feature_engineering:incomplete_large_connector", "#forge:slimeballs"])
	]).transitionalItem("create_feature_engineering:incomplete_larger_connector").loops(1)
	...
	create.sequenced_assembly([
		...
		create.deploying("create_feature_engineering:incomplete_portable_energy_interface", ["create_feature_engineering:incomplete_portable_energy_interface", "#anvilcraft:capacitor"]),
		create.deploying("create_feature_engineering:incomplete_portable_energy_interface", ["create_feature_engineering:incomplete_portable_energy_interface", "createaddition:copper_spool"])
	]).transitionalItem("create_feature_engineering:incomplete_portable_energy_interface").loops(1)
	...
	//水晶核心
	create.sequenced_assembly([
		Item.of("create_feature_engineering:crystal_core")
	], "spectrum:polished_calcite_slab", [
		create.deploying("create_feature_engineering:incomplete_crystal_mechanism", ["create_feature_engineering:incomplete_crystal_mechanism", "minecraft:amethyst_shard"]),
		create.deploying("create_feature_engineering:incomplete_crystal_mechanism", ["create_feature_engineering:incomplete_crystal_mechanism", "spectrum:citrine_shard"]),
		create.deploying("create_feature_engineering:incomplete_crystal_mechanism", ["create_feature_engineering:incomplete_crystal_mechanism", "spectrum:topaz_shard"])
	]).transitionalItem("create_feature_engineering:incomplete_crystal_mechanism").loops(1)

	//缟玛瑙构件
	create.sequenced_assembly([
		Item.of("create_feature_engineering:onyx_mechanism")
	], "create_feature_engineering:crystal_core", [
		create.deploying("create_feature_engineering:incomplete_onyx_mechanism", ["create_feature_engineering:incomplete_onyx_mechanism", "spectrum:polished_basalt_slab"]),
		create.deploying("create_feature_engineering:incomplete_onyx_mechanism", ["create_feature_engineering:incomplete_onyx_mechanism", "spectrum:onyx_shard"]),
		create.filling("create_feature_engineering:incomplete_onyx_mechanism", ["create_feature_engineering:incomplete_onyx_mechanism", Fluid.of("minecraft:lava", 500)]),
	]).transitionalItem("create_feature_engineering:incomplete_onyx_mechanism").loops(1)
})
