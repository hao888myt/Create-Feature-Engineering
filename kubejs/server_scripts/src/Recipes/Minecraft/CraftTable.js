ServerEvents.recipes(event => {
  ...
  // 数字0
  event.shaped(Item.of("kubejs:zero", 8), [
    "ZZZ",
    "Z Z",
    "ZZZ"
  ], {
  ...
  let unstackable_numbers = [
    ["kubejs:unstackable_zero", "kubejs:zero"],
    ["kubejs:unstackable_one", "kubejs:one"],
    ["kubejs:unstackable_two", "kubejs:two"],
    ["kubejs:unstackable_three", "kubejs:three"],
    ["kubejs:unstackable_four", "kubejs:four"],
    ["kubejs:unstackable_five", "kubejs:five"],
    ["kubejs:unstackable_six", "kubejs:six"],
    ["kubejs:unstackable_seven", "kubejs:seven"],
    ["kubejs:unstackable_eight", "kubejs:eight"],
    ["kubejs:unstackable_nine", "kubejs:nine"]
  ]
